...
export function TopMenuClient(props: TopMenuClientProps) {
  ...
  function closeMenu() {
    document.getElementById("top-menu-popover")?.hidePopover();
  }
  ...
  return (
    <>
      <button
        popoverTarget="top-menu-popover"
      ...
      <div
        ...
        className={css({
          ...
          position: "absolute",
          positionAnchor: "--top-menu-trigger",
          top: "anchor(bottom)",
          right: "anchor(right)",
          marginTop: "2",
          "&:popover-open": {
      ...
      >
        <div>
          <header className={popoverHeaderStyles}>{props.dict["top-menu"].menu.language}</header>
          {languageItems.map((language) => (
            <a key={language.id} href={`/${language.id}/linkbio`} onClick={closeMenu} className={css(itemStylesRaw)}>
        ...
        <div>
          <header className={popoverHeaderStyles}>{props.dict["top-menu"].menu.share}</header>
          <button onClick={onCopyLinkbio} className={hstack({ ...itemStylesRaw, gap: 2 })}>
